...
?>
                ...
                <form action="" method="post">
                    ...
                    <input type="text" name="username" id="" class="form-control mt-3" placeholder="username" required>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($sql)) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="usDe.php?did=<?php echo $row['user_id']; ?>" class="btn btn-danger"><i class="bi bi-person-x"></i></a>
                                    <a href="usEdi.php?Eid=<?php echo $row['user_id']; ?>" class="btn btn-success editbtn"><i class="bi bi-pencil-square"></i></a>
                                </td>
